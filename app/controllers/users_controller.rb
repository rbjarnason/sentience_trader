...
class UsersController < ApplicationController
  ...
  def complete_login
    if xml_request?
      ...
      if session[:intended_action]
        ...
        redirect_to :controller => "quote_targets"
      end
    end
  end
  ...
  def login
    ...
    if request.post? and params[:st_action]=="login"
    ...
    elsif request.post? and params[:st_action]=="create"
  ...
  def logout
    ...
    reset_session
    session[:user_id] = nil
    redirect_to(:controller => "quote_targets") unless xml_request?
  end
